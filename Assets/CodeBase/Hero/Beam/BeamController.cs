...
public class BeamController : MonoBehaviour
{
    ...
    private void Start()
    {
        _meshGenerator = GameObject.FindObjectOfType<MeshGenerator>();
    }
    ...
    private void Update()
    {
        ...
        _meshGenerator.Generate(leftPoint, _model.LeftStartPos, _model.RightStartPos, rightPoint, midleftPoint,
            midRightPoint);
    }
}