...
namespace CodeBase.Hero.Beam
{
    public class BeamModel : MonoBehaviour
    {
        ...
        {
            get { return _middleAngle - _castAngle + UfoRotation; }
        }
        ...
        //Cast
        public float Range => heroIntake.CurrentLength + _startRange;
        ...
        [Header("")] [SerializeField] private LayerMask _castMask;
        [Range(0, 360f)] [SerializeField] private float _castAngle = 45f;
    }
}